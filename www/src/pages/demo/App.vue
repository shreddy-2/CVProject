<template>
  <div id="app">
    <Navbar></Navbar>
    <div class="absolute top-16 bottom-0 left-0 right-0 bg-blue-400">
      ...
      <div class="absolute top-0 right-0 h-1/2 w-1/2 border-gray-800">
        ...
        <canvas class="object-none object-center bg-gray-100 border-gray-800" id="canvas-mask"></canvas>
      </div>
...
export default {
  ...
  methods: {
    canvas_in: function() {return document.getElementById("canvas-in");},
    canvas_mask: function() {return document.getElementById("canvas-mask");},
    canvas_background: function() {return document.getElementById("canvas-background");},
    canvas_foreground: function() {return document.getElementById("canvas-foreground");},
    ...
    resize: function() {
      console.log("resize");
      [this.canvas_in(), this.canvas_mask(), 
       this.canvas_background(), this.canvas_foreground()]
      .forEach((c) => {
    ...
    init_selfie_segmentation: function() {
      this.selfie_segmentation = new SelfieSegmentation({locateFile: (file) => {
